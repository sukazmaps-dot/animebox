...
for (const [label, source, needle] of [
  ...
  ['bounded sequential source fallback', episodePage, 'runProviderAttempt('],
  ['per-provider source deadline', episodePage, 'providerTimeouts.get(provider)'],
  ['global source discovery budget', episodePage, 'discoveryBudgetMs - discoveryElapsedMs'],
