...
export default function EpisodeRouteError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error('[Episode route boundary]', error);
  }, [error]);
    ...
    <main className="mx-auto flex min-h-[70vh] max-w-3xl items-center px-4 py-16 md:px-6">
      <section className="w-full rounded-2xl border border-white/10 bg-slate-950/75 p-6 shadow-2xl md:p-8">
        ...
        <p className="mt-3 text-sm leading-6 text-white/55">
          Плеер или один из внешних источников временно недоступен. Прогресс и
          аккаунт не затронуты.
        </p>
