-- AnimeBox 18.0 — Search lexical/hybrid ranker v2
-- Server-only RPC. Title/alias relevance must dominate long search_text matches.
...
as $$
  ...
  order by s.score desc, s.updated_at desc, s.anime_id asc
